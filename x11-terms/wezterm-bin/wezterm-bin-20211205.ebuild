...
# Portage.
SRC_URI="https://github.com/wez/wezterm/releases/download/20211205-192649-672c1cc1/wezterm-20211205-192649-672c1cc1.Ubuntu20.04.tar.xz"
...
src_install() {
	dobin usr/bin/strip-ansi-escapes
	dobin usr/bin/wezterm
	dobin usr/bin/wezterm-gui
	dobin usr/bin/wezterm-mux-server
	insinto /etc/profile.d
	doins etc/profile.d/wezterm.sh
	doicon -s 128 usr/share/icons/hicolor/128x128/apps/org.wezfurlong.wezterm.png
	domenu usr/share/applications/org.wezfurlong.wezterm.desktop
}
